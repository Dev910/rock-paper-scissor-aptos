address 0x057e685b9c2b682b204d584d4d1a1274577cbe81edd1e10ca530106a7c2d017d {
...
module RockPaperScissors{
    ...
    /// Function to start a new game. If a game already exists, reset its state.
    public entry fun start_game(account: &signer) acquires Game {
        let player = signer::address_of(account);

        if (exists<Game>(player)) {
            // If the game already exists, reset the game state
